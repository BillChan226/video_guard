...
guardrail = Conversation(
    system="A chat between a curious human and a guardrail model to detect unsafe content. "
           "The assistant gives accurate feedback on whether the input video contains unsafe content.",
    roles=("Human", "Assistant"),
    messages=(
        ("Human", "Hi!"),
        ("Assistant", "Hi there! How can I help you today?")
