...
if __name__ == '__main__':
    ...
    # video_path = "/scratch/czr/video_guard/dataset/ssstwitter.com_1719152443478.mp4" # fail
    video_path = "/scratch/czr/video_guard/dataset/tweeload_Sj0On2.mp4"
    ...
    # Input Text
    qs = "Is there is NSFW contained in the video?"
